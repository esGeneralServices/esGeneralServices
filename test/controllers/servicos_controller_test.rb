...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference("Servico.count") do
      post servicos_url, params: { servico: { descricao: @servico.descricao, horaFinal: @servico.horaFinal, horaInicio: @servico.horaInicio, nome: @servico.nome, tipo: @servico.tipo, valor: @servico.valor } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { descricao: @servico.descricao, horaFinal: @servico.horaFinal, horaInicio: @servico.horaInicio, nome: @servico.nome, tipo: @servico.tipo, valor: @servico.valor } }
