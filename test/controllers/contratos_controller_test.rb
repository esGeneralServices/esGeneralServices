...
class ContratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contrato" do
    assert_difference("Contrato.count") do
      post contratos_url, params: { contrato: { cliente_id: @contrato.cliente_id, servico_id: @contrato.servico_id } }
    end
  ...
  test "should update contrato" do
    patch contrato_url(@contrato), params: { contrato: { cliente_id: @contrato.cliente_id, servico_id: @contrato.servico_id } }
