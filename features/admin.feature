Feature: Admin
  ...
  Scenario: Visualizar cliente
    Given o cliente com nome 'teste', cpf '70369935454', email 'teste@email.com' e senha '123456' existe
  ...
  Scenario: Visualizar trabalhador
    And o trabalhador com nome 'teste2', cpf '70369935454', profissao 'agricultor', email 'teste2@email.com' e senha '123456' existe
    And eu estou na tela de admin com nome 'admin', email 'admin@admin.com' e senha '123456'
  ...
  Scenario: Remover trabalhador
    Given o trabalhador com nome 'teste2', cpf '70369935454', profissao 'agricultor', email 'teste2@email.com' e senha '123456' existe
    And eu estou na tela de admin com nome 'admin', email 'admin@admin.com' e senha '123456'
    When clico em mostrar trabalhadores
